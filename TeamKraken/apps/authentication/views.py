...
#FUNCIÓN TEMPORAL PARA REFRESCAR EL TOKEN
    ...
    def post(self, request, *args, **kwargs):
        ...
        if login_serializer.is_valid():
            ...
            if user.is_active:
                ...
                return Response({'error': 'Este usuario no puede iniciar sesión porque ya está activo.'},
...
class Logout(APIView):
    ...
    def get(self, request, *args, **kwargs):
        #Desde el frontend deberemos enviar el token en el parámetro 'token' del request
        try:
